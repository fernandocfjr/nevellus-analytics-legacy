...
import { useAllPairsInNevellusSwap, useAllTokensInNevellusSwap } from '../../contexts/GlobalData'
...
export const Search = ({ small = false }) => {
  let allTokens = useAllTokensInNevellusSwap()
  const allTokenData = useAllTokenData()

  let allPairs = useAllPairsInNevellusSwap()
        ...
        <Input
          ...
          placeholder={
            small
              ...
              ? 'Search...'
              : below470
              ? 'Search Nevellus Swap...'
              : below700
              ? 'Search pairs and tokens...'
              : 'Search Nevellus Swap pairs and tokens...'
          }
          value={value}
          onChange={(e) => {
